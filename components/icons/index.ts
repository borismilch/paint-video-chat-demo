...
export { SiBlazor } from 'react-icons/si'

export { BsChatDots } from 'react-icons/bs'
...
export { FaPaintBrush, FaPaintRoller, FaEraser, FaShapes, FaImage, FaSave, FaFileDownload, FaShareSquare } from 'react-icons/fa'
export { AiOutlineClear } from 'react-icons/ai'